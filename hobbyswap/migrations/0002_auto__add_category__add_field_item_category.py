...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hobbyswap_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'hobbyswap', ['Category'])

        # Adding field 'Item.category'
        db.add_column(u'hobbyswap_item', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='item_category', null=True, to=orm['hobbyswap.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'hobbyswap_category')

        # Deleting field 'Item.category'
        db.delete_column(u'hobbyswap_item', 'category_id')
    ...
    models = {
        ...
        u'hobbyswap.item': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'item_category'", 'null': 'True', 'to': u"orm['hobbyswap.Category']"}),
