...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Review'
        db.create_table(u'hobbyswap_review', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviewed_item', to=orm['hobbyswap.Item'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=3000)),
        ))
        db.send_create_signal(u'hobbyswap', ['Review'])


    def backwards(self, orm):
        # Deleting model 'Review'
        db.delete_table(u'hobbyswap_review')
    ...
    models = {
        ...
        u'hobbyswap.review': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reviewed_item'", 'to': u"orm['hobbyswap.Item']"}),
